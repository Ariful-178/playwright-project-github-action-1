    ...
    use: {
        ...
        launchOptions: {
            args: [
                ...
                "--use-file-for-fake-video-capture=".concat(__dirname, "/VR.y4m"),
            ],
    ...
    projects: [
        {
            ...
            teardown: 'Cleanup' // Added teardown hook
        },
        {
            name: 'Cleanup',
            testMatch: "auth.teardown.ts" // Added cleanup project
        },
        {
            name: 'chromium',
            use: __assign(__assign({}, test_1.devices['Desktop Chrome']), { storageState: '.auth/auth.json' }),
            dependencies: ['auth'],
        },
